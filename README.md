...
* 📚 **Архив** - хранение ранее созданных PDF с возможностью просмотра и скачивания. Повтор той же даты, локации и типа меню у администратора сначала спрашивает, заменять ли файл.
...
* 🤖 **Бот Telegram** — по желанию, отдельным сервисом. Мини-приложение собирает меню и присылает PDF в личный чат. Как пользоваться: [GUIDE.MD](GUIDE.MD), раздел 12. Как подключить: [INSTALL.MD](INSTALL.MD).
...
* журнал изменений блюд (DishChangeLog) и опциональный debug-лог в интерфейсе Admin.
