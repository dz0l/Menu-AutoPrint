...
MENU_ARCHIVE_RETENTION_DAYS = env_int("MENU_ARCHIVE_RETENTION_DAYS", 730)
MENU_ARCHIVE_LOW_SPACE_BYTES = env_int("MENU_ARCHIVE_LOW_SPACE_BYTES", 2 * 1024 * 1024 * 1024)
...
INTEGRATION_API_ENABLED = env_bool("INTEGRATION_API_ENABLED", "0")
INTEGRATION_SERVICE_USER_ID = env_int("INTEGRATION_SERVICE_USER_ID", 0)
INTEGRATION_API_KEY_HASH = os.environ.get("INTEGRATION_API_KEY_HASH", "").strip()
INTEGRATION_OPERATION_TTL_HOURS = env_int("INTEGRATION_OPERATION_TTL_HOURS", 24)
